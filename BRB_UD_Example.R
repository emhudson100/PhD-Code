...
# set the nb_iteration to 1000 or to the max possible if less than 100 are available
...
#save sub.df
write.csv(sub.df, file=paste("subsetSummary_period",period,".csv",sep=""), row.names=F)
...
write.csv(HR_summary, file= "HR_summary.csv")
